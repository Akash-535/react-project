                ...
                {DASHBOARD_CARS_DATA.map((data, i) => (
                    <div key={i} className='w-5/12 max-xl:w-full flex justify-center gap-0 px-3 items-center flex-wrap'>
                        <Tilt className="flex justify-center items-center">
                            <div className='border bg-green-700 size-60 px-60 max-lg:px-48 max-md:px-40 justify-center items-center flex w-6/12 text-white text-nowrap text-5xl font-bold hover:bg-gradient-to-r hover:from-slate-600 hover:via-orange-600 hover:to-violet-700 duration-500 ease-linear'>{data.text}</div>
                        </Tilt>
                    </div>
                ))}
            </div>
